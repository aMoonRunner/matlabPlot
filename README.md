...
- [1. matlab 绘图学习笔记](#1-matlab-绘图学习笔记)
  - [1.1. 科研绘图常用软件(数据图)](#11-科研绘图常用软件数据图)
    - [1.1.1. matlab](#111-matlab)
    - [1.1.2. origin](#112-origin)
    - [1.1.3. python](#113-python)
    - [1.1.4. R 语言](#114-r-语言)
    - [1.1.5. 其它](#115-其它)
  - [1.2. matlab 绘图](#12-matlab-绘图)
  - [1.3. 细节调整与其他](#13-细节调整与其他)
    - [1.3.1. 调整坐标轴小数位数](#131-调整坐标轴小数位数)
    - [1.3.2. 调整图例中线段的长度](#132-调整图例中线段的长度)
    - [1.3.3. 双坐标轴](#133-双坐标轴)
    - [1.3.4. 添加标注](#134-添加标注)
    - [1.3.5. 其他类型的图\&\&图通道](#135-其他类型的图图通道)
  - [1.4. 附录 完整程序](#14-附录-完整程序)
